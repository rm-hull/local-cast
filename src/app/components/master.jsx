...
const Master = React.createClass({
      ...
      <AppCanvas>
        ...
        <FullWidthSection style={styles.footer}>
          <p style={this.prepareStyles(styles.p)}>
            Built by <a style={styles.a} href="mailto:richard.hull@destructuring-bind.org">richard.hull@destructuring-bind.org</a>, based on
            examples from <a style={styles.a} href="http://material-ui.com">material-ui.com</a> and other contributors.
          </p>
          {githubButton2}
        </FullWidthSection>
      </AppCanvas>
  ...
  _getSelectedIndex() {
    return this.props.history.isActive('/get-started') ? '1' :
      ...
      this.props.history.isActive('/media') ? '3' : '0';
  },
  ...
  _getAppBar() {
    let title =
      ...
      this.props.history.isActive('/media') ? 'Media' : '';
